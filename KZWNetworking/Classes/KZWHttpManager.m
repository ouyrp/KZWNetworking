...
+ (AFHTTPSessionManager *)sharedRequestOperationManager {
    ...
    dispatch_once(&onceToken, ^{
        ...
        _sharedRequestOperationManager.requestSerializer.timeoutInterval = 30.0; // 超时限制
        ...
        [_sharedRequestOperationManager.requestSerializer setValue:[UIApplication KZW_version] forHTTPHeaderField:@"version"];
        [_sharedRequestOperationManager.requestSerializer setValue:[UIApplication KZW_userAgent] forHTTPHeaderField:@"userAgent"];
    });
...
+ (AFSecurityPolicy *)customSecurityPolicy {
    ...
    NSString *bundlePath = [[NSBundle bundleForClass:[self class]].resourcePath
        stringByAppendingPathComponent:@"/KZWNetworking.bundle"];
